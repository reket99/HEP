			...
			<div class="login-page-wrapper">
				<?php if($page['content']):?>
						...
						<div class="content-login">
							<!-- <div class="news_ticker" style="background-color:#ffffff !important; padding-bottom:20px;">
								<div class="ticker_holder"> 
									<marquee behavior="scroll" direction="left" scrollamount="3" onmouseover="this.stop();" onmouseout="this.start();">We will be carrying out scheduled maintenance work on our website on 21st June 2014, from midnight to 6AM. The website would be inaccessible during that period. We apologize for any inconveniences caused.</marquee>
								</div>
							</div>-->
